...
import db from '$lib/server/SSCdb';
...
let authKey = "p25LH698ItQbLdz9"; // Please use the credentials shared by your Account Manager  If not, please contact your Account Manage
